...
describe('mathy.yieldPrimesViaSieve', () => {
	it('yields primes', () => {
		let yielder = Mathy.yieldPrimesViaSieve()
		expect(yielder.next().value).toEqual(2)
		expect(yielder.next().value).toEqual(3)
		expect(yielder.next().value).toEqual(5)
		expect(yielder.next().value).toEqual(7)
		expect(yielder.next().value).toEqual(11)
		expect(yielder.next().value).toEqual(13)
		expect(yielder.next().value).toEqual(17)
		expect(yielder.next().value).toEqual(19)
		expect(yielder.next().value).toEqual(23)
	})
	it('yields primes until cap is hit', () => {
		let yielder = Mathy.yieldPrimesViaSieve(22)
		expect(yielder.next().value).toEqual(2)
		expect(yielder.next().value).toEqual(3)
		expect(yielder.next().value).toEqual(5)
		expect(yielder.next().value).toEqual(7)
