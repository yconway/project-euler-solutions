...
describe('mathy.yieldFibonacci', () => {
	it('yields fibonacci', () => {
		...
		expect(yielder.next()).toEqual(1)
		expect(yielder.next()).toEqual(1)
		expect(yielder.next()).toEqual(2)
		expect(yielder.next()).toEqual(3)
		expect(yielder.next()).toEqual(5)
		expect(yielder.next()).toEqual(8)
		expect(yielder.next()).toEqual(13)
		expect(yielder.next()).toEqual(21)
		expect(yielder.next()).toEqual(34)
	})
	it('yields fibonacci', () => {
		...
		expect(yielder.next()).toEqual(13)
		expect(yielder.next()).toEqual(21)
		expect(yielder.next()).toEqual(undefined)
	})
})
